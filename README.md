...
Desenvolvida para o **Desafio Edenred**, a aplicação quantifica as emissões de CO₂e evitadas pelo uso de tag de pedágio e estacionamento — eliminando filas, picos de aceleração e tickets de papel — com base nas metodologias oficiais do **GHG Protocol Brasil**, **INMETRO/PBE Veicular** e **CETESB**.

![Python](https://img.shields.io/badge/Python-3.10%2B-3776AB?style=flat-square&logo=python&logoColor=white)
![Gradio](https://img.shields.io/badge/Gradio-4.20%2B-FF7C00?style=flat-square&logo=gradio&logoColor=white)
![License](https://img.shields.io/badge/Licença-MIT-2E7D32?style=flat-square)
![Status](https://img.shields.io/badge/Status-Em%20desenvolvimento-FFB300?style=flat-square)
...
| Módulo | Descrição |
|---|---|
| **🚗 Cadastro de Veículos** | Registra nome, categoria (Passeio / SUV / Pesado) e motorização; agrupa em frotas nomeadas |
| **🔢 Simulador de Emissões** | Compara CO₂e com e sem tag para um veículo individual ou frota inteira; recebe km, pedágios e estacionamentos |
| **🏅 Gamificação** | Atribui medalha Bronze / Prata / Ouro com base no total de emissões evitadas |
| **📄 Relatório PDF** | Exporta relatório individual ou de frota com KPIs, gráficos, tabelas e perfil ecológico |
| **📊 Fundamentação Científica** | Painel com 7 gráficos de storytelling: ranking de emissão direta, pegada oculta, LCA, projeção acumulada e mais |
...
├── apresentacao.py          # Painel científico: referências e 7 gráficos ETL
...
└── utilitarios/
    ├── __init__.py
    └── pdf_generator.py     # Geração de PDFs individuais e de frota (ReportLab)
```
...
A interface abrirá em `http://localhost:7860` no navegador.
...
Apenas as emissões diretas de rodagem: `distância (km) × fator CO₂ (g/km) ÷ 1.000`.
...
| Categoria | Combustível | CO₂ direto (g/km) |
|---|---|---|
| Passeio | Gasolina | 140 |
| Passeio | Flex | 110 |
| Passeio | HEV | 78 |
| Passeio | PHEV | 42 |
| Passeio | BEV | 11,2 |
...
> Tabela completa em [`pipeline/extract.py`](pipeline/extract.py)

---

## 📄 Relatório PDF

Ao clicar em **PDF – Veículo Selecionado** ou **PDF – Frota Selecionada**, é gerado um relatório executivo (ReportLab / A4) contendo:
...
- **Perfil ecológico** — medalha de gamificação e descrição do nível

---

## 🏅 Sistema de Gamificação

| Medalha | CO₂e evitado por veículo | Descrição |
|---|---|---|
...
## 📊 Painel Científico (Aba 3)

A aba **Fundamentação de Pesquisa e Gráficos** gera um painel PNG com **7 visualizações** de storytelling científico renderizadas sob demanda a partir dos dados do ETL:

| # | Gráfico | Fonte |
|---|---|---|
| ① | Ranking de emissão direta CO₂ por combustível + meta MOVER | INMETRO/PBE + ICCT |
| ② | Pegada oculta: emissão stacked com tag vs. sem tag (100 km) | CETESB + GHG Protocol |
| ③ | Consumo em marcha lenta por motorização | CETESB |
| ④ | Fator de emissão do combustível (kg CO₂e/l) | GHG Protocol Brasil |
| ⑤ | Ciclo de vida completo LCA por fase | ANFAVEA & BCG |
| ⑥ | Projeção de CO₂ evitado acumulado ao longo da quilometragem | ICCT / MOVER |
| ⑦ | Scatter: marcha lenta × consumo de arrancada por categoria | CETESB |
...
- [ANFAVEA & BCG – Caminhos da Descarbonização](https://web-assets.bcg.com/30/97/e8e78976425983c13e92de4af084/caminhos-descarbonizacao-setor-automotivo-brasil.pdf)
- [ICCT – Emissões de CO₂ (Programa MOVER: Mai 2024 – Jun 2025)](https://theicct.org/emissoes-de-co2-dos-carros-de-passeio-segundo-parametros-oficiais-do-programa-mover-maio-2024-junho-2025/)
